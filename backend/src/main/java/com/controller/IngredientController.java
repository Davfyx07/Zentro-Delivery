...
import com.model.IngredientCategory;
...
public class IngredientController {
    ...
    public ResponseEntity<List<IngredientCategory>> getRestaurantIngredient(
        @PathVariable Long id) throws Exception {
    ...
    @GetMapping("/restaurant/{id}/stock")
    public ResponseEntity<List<IngredientsItem>> getRestaurantIngredientCategory(
        @PathVariable Long id) throws Exception {
